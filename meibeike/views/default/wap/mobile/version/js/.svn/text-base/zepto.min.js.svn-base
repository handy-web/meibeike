...
var Zepto = function() {
	...
	return Y.matches = function(t, e) {
		...
		if(!t) return Y.Z();
		if("string" == typeof t)
			if(t = t.trim(), "<" == t[0] && L.test(t)) i = Y.fragment(t, RegExp.$1, n), t = null;
			else {
			...
			else if(L.test(t)) i = Y.fragment(t.trim(), RegExp.$1, n), t = null;
			else {
				if(n !== E) return T(n).find(t);
				i = Y.qsa(Z, t)
			}
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		C.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			if(u.xhrFields)
				for(v in u.xhrFields) S[v] = u.xhrFields[v];
	...
	function(t) {
		function e(t, e) {
			var n = this.os = {},
				...
				C = T || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
