...
<div class="wap">		
			...
			<div class="login-c">
				...
				<!--  <div class="login-ot"> 
					...
					<ul class="login-li">
						<li>
							<a href='<?php echo IUrl::creatUrl("/simple/third_login/api/wb");?>'><img class="img-qq" src="/views/default/wap/mobile/version/img/app-wb.png"/></a>
							<div class="text-qq">微博</div>
						</li>
						<li>
							<a href='<?php echo IUrl::creatUrl("/simple/third_login/api/wx");?>'><img class="img-qq" src="/views/default/wap/mobile/version/img/app-wx.png"/></a>
