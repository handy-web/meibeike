...
<body>
	...
	body{background: #F9F9F9;}
		...
		<ul class="reg-c">
			<li><a href="<?php echo IUrl::creatUrl("/wap/phone_reg");?>" class="reg-act">手机注册</a></li>
			<li><a href="<?php echo IUrl::creatUrl("/wap/mail_reg");?>">邮箱注册</li></a>
		</ul>	
...
<script>
    var handlerPopup = function (captchaObj) {
        $("#to_submit").click(function () {
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo IUrl::creatUrl("wap/verify_telphone_reg");?>",
    ...
    $.ajax({
		...
		function time(o) {
		 ...
		 function sendVerify(telphone) {
		     $.ajax({
		         type: "POST",
		         url: "<?php echo IUrl::creatUrl("wap/verify_telphone");?>",
		         data: "mobile="+$('input[name="mobile"]').val(),
		         dataType: "json",
