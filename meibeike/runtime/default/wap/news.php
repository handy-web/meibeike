	...
	body{background: #F9F9F9;}
		...
		<div class="cur-more">
			<ul class="cur-ul">
				...
				<li>
					<a href = "<?php echo IUrl::creatUrl("/wap/news_detail/id/");?><?php echo isset($item['id'])?$item['id']:"";?>">
						<span class="flt news-w"><i>●</i> <?php echo isset($item['name'])?$item['name']:"";?></span>	
						<span class="frt new-time"><?php echo date('Y/m/d',$item['dateline']);?></span>
					</a>
				</li>
				<?php }?>
			</ul>	
