...
<body>
	...
	body{background: #F5F5F5;}
		...
		<div class="err-box">
			<img src="/views/default/wap/mobile/version/img/app-error.png"/>
			<p>Sorry...</p>
			<h3><?php echo isset($msg)?$msg:"";?></h3>
			<div class="err-but"><?php if($this->user['user_id']){?><a href='<?php echo IUrl::creatUrl("/wapcenter/personal");?>'>返回个人中心</a><?php }?></div>
		</div>
