...
<head>
    ...
    <!-- 页面标题,关键字,描述开始-->	
		...
		<?php }?>
	<!-- 页面标题,关键字,描述结束-->
    <link rel="stylesheet" href="/views/default/wap/mobile/version/css/main.css?08-01-02" />
...
<div class="cur-tab"><?php echo isset($detail['name'])?$detail['name']:"";?></div>
		<div class="cur-list">
			<?php echo isset($detail['content'])?$detail['content']:"";?>
		</div>
	</body>
</html>
