 ...
 */(function(g, h) {
	...
	c.fn.init = function(b, d) {
		...
		if ("head" === b || "html" === b)
			return this[0] = d.getElementsByTagName(b)[0], this;
	...
	c.event = {add: function(b, d, e) {
			...
			return function(d) {
				for (var d = c.event.fix(d || g.event), e = 0, a = b.listeners, f; f = a[e++]; )
...
//					d.top = b;
			...
			g.each(i, function(b, c) {
				...
				if (c.focus)
					a._focus && a._focus.removeClass("aui_state_highlight"), a._focus = g(i).addClass("aui_state_highlight"), a.focus();
			...
			for (var c = 0, d = {wrap: g(a)}, e = a.getElementsByTagName("*"), h = e.length; c < h; c++)
	...
	b._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:/*加载完成*/;">\u00d7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>';
