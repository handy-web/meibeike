...
$iweb = dirname(dirname(__FILE__)) . "/lib/iweb.php";
$config = dirname(dirname(__FILE__)) . "/config/config.php";
require($iweb);
IWeb::createWebApp($config)->run();

require_once IWeb::$app->getBasePath() . 'plugins/ucenter/uc_client/client.php';
...
include_once IWeb::$app->getBasePath() . 'plugins/ucenter/uc_client/lib/xml.class.php';
