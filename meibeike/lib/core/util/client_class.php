...
class IClient
{
   ...
   * @brief 获取网站来源url地址
   */
  public static function getSiteRefUrl(){
     $urlname = "";
   if (isset($_SERVER['HTTP_REFERER']))
   {     //有来源信息
       $url = $_SERVER['HTTP_REFERER'];  
      
       if (stripos($url,"dev.meibeike.com")===0 || stripos($url,"http://dev.meibeike.com")===0)
       {        
          $urlname = "";     
       }else{
   ...
   {   //没有来源信息
	...
	public static function getDevice()
	{
		...
		$mobileList = array('Android','iPhone','MicroMessenger','MQQBrowser');
