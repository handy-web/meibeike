	...
	private static $menu = array(
	   ...
	   '订单'=>array(
        	'订单管理'=>array(
				...
				'收货管理'=>array(
                '/order/order_fahuo' => '收款管理',
				'/order/order_beihuo' => '备货管理',
				'/order/order_chuhuo' => '出货管理',
        	),
        	'单据管理'=>array(
             	'/order/order_appoint_list'  => '预约单',
             	'/order/order_collection_list'  => '收款单',
             	'/order/order_refundment_list'  => '退款单',
        		'/order/order_delivery_list'    => '发货单',
        		/*'/order/refundment_list'        => '退款申请列表',*/
                    '/order/order_service_list' => '服务订单列表',
        	),
        	'发货地址'=>array(
		...
		'营销'=>array(
        	...
        	'F码管理'=>array(
        		...
        		'/market/fm_activity_list' => 'F码活动列表',
        		'/market/apply_fm_list' => 'F码申领列表',	
        		
        	),
        	'审核管理'=>array(
        	'/market/fm_activity_review_list' => 'F码活动审核列表',
        	),
        	'新聞管理'=>array(
        	...
        	'常见问题管理'=>array(
        			'/tools/common_problem_list' => '常见问题列表',
        	),
        	'帮助管理'=>array(
        ...
        '系统'=>array(
        	...
        	'支付管理'=>array(
            	...
            	'/system/order_overdue'=>'未支付订单过期配置'
        	),
        	/*'多平台登录'=>array(
...
/*
	...
	private static $menu_non_display = array(
		...
		'/market/add_fm_activity' => '/market/fm_activity_list',
		'/market/bill_edit' => '/market/bill_list',
		'/order/appoint_show' => '/order/order_appoint_list',
	...
	public function submenu($is_auto = false)
	{
		...
		//过滤无操作权限的菜单
		$this->filterMenu();
		//if(ISafe::get('admin_role_name') != '超级管理员'){
			//unset(self::$menu['系统']);
		//}
